...
from anuga.anuga_1d.base.generic_domain import *
import numpy
...
class Domain(Generic_domain):
    ...
    def __init__(self, coordinates, boundary = None, tagged_elements = None):
        ...
        from anuga.anuga_1d.config import minimum_allowed_height, g, h0
        ...
        from anuga.anuga_1d.base.util import mean
        self.reduction = mean
...
def compute_fluxes_channel(domain):
    ...
    from anuga.anuga_1d.channel.channel_domain_ext import compute_fluxes_channel_ext
...
def distribute_to_vertices_and_edges_limit_s_v(domain):
    import sys
    from anuga.anuga_1d.config import epsilon, h0
